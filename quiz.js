...
const q1 = {
    ...
    alternativaA: "Oceano Atlântico",
    alternativaB: "Oceano Pacífico",
...
const q2 = {
    numQuestao: 2,
        ...
        alternativaA: "Mônaco",
        alternativaB: "San Marino",
        alternativaC: "Vaticano",
        alternativaD: "Liechtenstein",
        correta: "Vaticano",
}
const q3 = {
    numQuestao   : 3,
    pergunta     : "Qual a principal função da nuvem computacional?",
    alternativaA : "Armazenar e acessar dados online",
    alternativaB : "Executar programas em servidores remotos",
    alternativaC : "Enviar e receber e-mails",
    alternativaD : "Navegar na internet",
    correta      : "Armazenar e acessar dados online",
}
const q4 = {
    numQuestao   : 4,
    pergunta     : "Ramo da fisica responsavel por estudar fenômenos elétricos",
    alternativaA : "Eletrônica",
    alternativaB : "Mecânica",
    alternativaC : "Eletricidade",
    alternativaD : "Computação",
    correta      : "Eletrônica",
}
const q5 = {
    numQuestao   : 5,
